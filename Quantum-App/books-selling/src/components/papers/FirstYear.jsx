...
import { CardContent, CardMedia,Box,Typography,Button,Card, useMediaQuery } from "@mui/material";
...
const FirstYear = ({ data,defaultImage }) => {
  ...
  return (
   <Box>
    ...
    },margin:'30px 0px'}} variant='h3'>First Year</Typography>
     <Swiper
